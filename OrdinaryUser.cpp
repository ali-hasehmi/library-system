...
OrdinaryUser::OrdinaryUser(const std::string &_first_name, const std::string &_last_name,
                           const std::string &_national_code, const std::string &_user_name,
...
void OrdinaryUser::idSetter(int id)
{
    this->m_id = id;
}

void OrdinaryUser::userNameSetter(std::string argUserName)
{
    this->m_user_name = argUserName;
}
